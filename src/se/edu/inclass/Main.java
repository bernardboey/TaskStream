...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total number of deadlines (using stream): " + countDeadlines(tasksData));
    ...
    private static ArrayList<Task> filterTasksByString(ArrayList<Task> tasks, String filterString) {
